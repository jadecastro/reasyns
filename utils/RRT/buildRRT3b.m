function [path,i] = buildRRT3b(vBound,Xreg1,Xreg2,B1,B2,x,qInit,qGoal,stepSize,n,radius)
...
%     end
    ...
    % If not, go fish
    [qNew,nearI] = addNode3(vBound,Xreg1,Xreg2,B1,B2,x,qGoal(1:2),node,gaussWeight,M,stepSize,radius);
