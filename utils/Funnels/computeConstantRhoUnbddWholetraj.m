function [rhoMin,rho_d,Info] = computeConstantRhoUnbddWholetraj(f0,ts,Ac,K,xMu,uk,Eprior,H,n,isCyclic,succRegChk)
...
[rho_sos,Info,posDefMultiplier] = computeRhoFeasBilinearAlternationWhole(V,xdot,tau_sos);
Info
