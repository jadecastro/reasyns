function [funnel,info,redindx] = computeController(f0,t,Xk,Uk,S0,Q,R,H,n,isCyclic,skipFun,regBnd,X,reg1,reg2,Xbound1,Xbound2,Xin1,Xin2,ellBndInv1,ellBndInv2,ellInInv1,ellInInv2)
...
for ith = ithSet
    ...
    tspan = linspace(tspan(1),tspan(2),500);
