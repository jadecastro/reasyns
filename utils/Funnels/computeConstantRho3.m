function [rhoMin,rho_d,Info] = computeConstantRho3(f0,ts,Ac,K,xMu,uk,regBnd,X,Eprior,P1,reg1,Xbnd1,Xin1,P2,reg2,Xbnd2,Xin2,ellBndInv1,ellBndInv2,ellInInv1,ellInInv2,H,n,isCyclic,succRegChk,bloatFlag)
