...
for i = 1:size(funnelIn,1)
    if ~isempty(funnelIn{i,j,kiter}),
        ...
        plotEllipse(projection(E,[1 0;0 1;0 0;0 0]),options.color);
    end
end
options.fill = 1;
options.color = [0.5 0.5 0.5];
...
%     if ~isempty(ellFunnel{i,j,kiter}), plotEllipse(projection(ellFunnel{i,j,kiter},[1 0;0 1;0 0;0 0]),options.color); end
% end
...
plotEllipse(projection(ellTmp5,[1 0;0 1;0 0;0 0]),options.color);
options.color = [0.3 0.9 0.3];
% plotEllipse(projection(ellTmp1,[1 0;0 1;0 ;0 00]),options.color);
% options.color = [0.9 0.3 0.3];
% plotEllipse(projection(ellTmp2,[1 0;0 1;0 0;0 0]),options.color);
options.color = [0.9 0.3 0.3];
plotEllipse(projection(ellTmp4,[1 0;0 1;0 0;0 0]),options.color);
options.color = [0.3 0.9 0.3];
plotEllipse(projection(ellTmp3,[1 0;0 1;0 0;0 0]),options.color);
