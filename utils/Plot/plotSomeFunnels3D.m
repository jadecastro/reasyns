...
plot3([vReg{1}(2,1) vReg{1}(3,1)],[vReg{1}(2,2) vReg{1}(3,2)],funnel{ii,jj}.x(end,3)*[1 1],'k--','LineWidth',2)
...
plot3([vReg{3}(1,1) vReg{3}(2,1)],[vReg{3}(1,2) vReg{3}(2,2)],funnel{ii,jj}.x(end,3)*[1 1],'k--','LineWidth',2)
plot3([vReg{3}(4,1) vReg{3}(1,1)],[vReg{3}(4,2) vReg{3}(1,2)],funnel{ii,jj}.x(end,3)*[1 1],'k--','LineWidth',2)
